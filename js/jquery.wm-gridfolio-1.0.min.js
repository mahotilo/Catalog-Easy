//Updated be Mahotilo
// * fix arrows when keepOpen=true
// * fix calculation of .wmg-details.open height
// * if parent has 'open' class, open first description
// * fix missed 'px' in styles
    ...
    $.fn.extend({
        WMGridfolio: function (options) {
            ...
            util = {
                ...
                openContent : function(thumb){
                    var $el     = thumb,
                        ...
                        auto_h  = $parent.find('.'+d+' > div').height(),
            ...
            funcs = {
                ...
                dynamicCSS : function(el, item, thumb, arrow){
                    var $e      = el, 
                        ...
                        auto_h  = $e.parent().find('.'+d+' > div').height(),
                ...
                staticCSS : function(el, item, thumb, details, arrow){
                    ...
                    $d.find('> div').css({
                        'min-height' : options.details.minHeight+'px'
                    });
            ...
            return this.each(function () {
				...
				if ( $el.parents('div').hasClass(options.config.open) ) {
                    setTimeout(function(){
                    	util.openContent($thumb.first());
                        $thumb.first().parent().parent().addClass(open);
                  }, 300);
				};
